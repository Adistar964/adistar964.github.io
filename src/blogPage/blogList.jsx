    ...
    useEffect(() => {
        ...
        .then(data => {
            if(data.code=="success"){
                ...
                window.open("http://localhost:5173/") // any error, then we send user back to home page
            }
            setLoading(false)
    ...
    <div className="card mx-auto my-4" style={{maxWidth:"795px"}}>
        ...
        <div className="card-body p-4">
            ...
            <div className="mt-3 d-flex justify-content-between align-items-center">
                ...
                onClick={()=>navigator.share({title:"Abdullah's Blog-Post",url:`http://localhost:5173/blogs/${props._id}`})}>
